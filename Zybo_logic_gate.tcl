...
################################################################
# This is a generated script based on design: Zybo_logic_gate
#
...
# source Zybo_logic_gate_script.tcl
...
set design_name Zybo_logic_gate
...
\
  ...
  connect_bd_net -net AND_Gate_0_y [get_bd_pins AND_Gate_0/y] [get_bd_pins axi_gpio_0/gpio_io_i]
  connect_bd_net -net a_0_1 [get_bd_ports sw1] [get_bd_pins AND_Gate_0/a]
  connect_bd_net -net axi_gpio_1_gpio_io_o [get_bd_pins axi_gpio_1/gpio_io_o] [get_bd_ports LED]
  connect_bd_net -net b_0_1 [get_bd_ports sw0] [get_bd_pins AND_Gate_0/b]
  connect_bd_net -net proc_sys_reset_0_peripheral_aresetn [get_bd_pins proc_sys_reset_0/peripheral_aresetn] [get_bd_pins ps7_0_axi_periph/S00_ARESETN] [get_bd_pins axi_gpio_0/s_axi_aresetn] [get_bd_pins ps7_0_axi_periph/M00_ARESETN] [get_bd_pins ps7_0_axi_periph/ARESETN] [get_bd_pins axi_gpio_1/s_axi_aresetn] [get_bd_pins ps7_0_axi_periph/M01_ARESETN]
